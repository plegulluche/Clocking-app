  ...
  <div class="background">
    ...
    <div class="card">
      <div class="containerAvatar">
        ...
        <h5>Time manager</h5>
        <h4>Register to Time Manager</h4>
        ...
        <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" class="demo-ruleForm">
          ...
          <el-form-item>
            <el-button class="submitButton" type="primary" @click="submitForm(ruleFormRef)">Register</el-button>
...
const submitForm = (formEl: FormInstance | undefined) => {
  ...
  formEl.validate((valid) => {
    if (valid) {
      userStore.register(ruleForm.name, ruleForm.email, ruleForm.pass);
